 ...
 */
final class Version20241225165646 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE usuario (id INT AUTO_INCREMENT NOT NULL, login VARCHAR(180) NOT NULL, roles JSON NOT NULL, login_estado VARCHAR(10) DEFAULT NULL, correo1 VARCHAR(100) DEFAULT NULL, correo2 VARCHAR(100) DEFAULT NULL, creado DATETIME NOT NULL, modificado DATETIME NOT NULL, UNIQUE INDEX UNIQ_2265B05DAA08CB10 (login), INDEX idx_login (login), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
